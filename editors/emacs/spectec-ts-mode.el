...
(defvar spectec-ts-mode--font-lock-settings
  (treesit-font-lock-rules
   ...
   :language 'spectec
   :feature 'keyword
   '(["syntax" "var" "relation" "rule" "dec" "def" "if" "hint" "property"]
     @font-lock-keyword-face
     "--" @font-lock-keyword-face
     (else_premise) @font-lock-keyword-face
     (if_premise "if" @font-lock-keyword-face)
     (builtin_generator_declaration ["builtin" "generator"] @font-lock-keyword-face))
   ...
   '((call_expression (function_id) @font-lock-function-call-face)
     ...
     (builtin_generator_declaration name: (function_id) @font-lock-function-name-face)
     (property_definition name: (relation_id) @font-lock-function-name-face)
