...
infix and unary operators, and every command form re-parses to the same tree
(the -r flag asserts this; on failure it prints "Roundtrip failed" and exits
nonzero instead of the surface below):
