...
let hints_of_typcase hmap (id : id) (typcase : typcase) =
...
let hints_of_typcases hmap id typcases =
  List.fold_left
    (fun hmap typcase -> hints_of_typcase hmap id typcase)
    hmap typcases

let hints_of_deftyp hmap id (deftyp : deftyp) =
