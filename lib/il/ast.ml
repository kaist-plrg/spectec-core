...
(* Parameters *)
and param = (typ, value, dir) Lang.param
and param' = (typ, value, dir) Lang.param'

(* Constructor parameters *)
and cparam = (typ, value, dir) Lang.cparam
and cparam' = (typ, value, dir) Lang.cparam'
...
(* Statements *)
and stmt = (typ, value, dir) Lang.stmt
and stmt' = (typ, value, dir) Lang.stmt'

(* Blocks (sequence of statements) *)
and block = (typ, value, dir) Lang.block
and block' = (typ, value, dir) Lang.block'

(* Match-cases for switch *)
and switch_label = Lang.switch_label
and switch_label' = Lang.switch_label'
and switch_case = (typ, value, dir) Lang.switch_case
and switch_case' = (typ, value, dir) Lang.switch_case'

(* Declarations *)
and decl = (typ, value, dir) Lang.decl
and decl' = (typ, value, dir) Lang.decl'

(* Parser state machine *)
and parser_state = (typ, value, dir) Lang.parser_state
and parser_state' = (typ, value, dir) Lang.parser_state'
...
(* Program *)
type program = (typ, value, dir) Lang.program
