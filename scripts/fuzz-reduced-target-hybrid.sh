...
./p4spectec testgen spec/*.watsup -i $DIR_INCLUDE -cold $DIR_SEED -target $FILE_TARGET -ignore $FILE_IGNORE_REL -ignore $FILE_IGNORE_FUNC -gen $DIR_GEN -silent -hybrid -fuel $FUEL
